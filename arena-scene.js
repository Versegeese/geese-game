    ...
    class Arena_Scene extends Scene_Component {
        constructor(context, control_box) { // The scene begins by requesting the camera, shapes, and materials it will need.
            ...
            this.materials = {
                ...
                marker_tile: context.get_instance(Phong_Shader).material(Color.of(0, 0, 0, 0.8), { ambient: 1, diffusivity: 0, specularity: 0, texture: context.get_instance("assets/tiles/marker.png", true) }),
                move_tile: context.get_instance(Phong_Shader).material(Color.of(0, 0, 0, 0.5), { ambient: 1, diffusivity: 0, specularity: 0, texture: context.get_instance("assets/tiles/move.png", true) }),
                attack_tile: context.get_instance(Phong_Shader).material(Color.of(0, 0, 0, 0.5), { ambient: 1, diffusivity: 0, specularity: 0, texture: context.get_instance("assets/tiles/attack.png", true) }),
                can_move_tile: context.get_instance(Phong_Shader).material(Color.of(0, 0, 0, 0.5), { ambient: 1, diffusivity: 0, specularity: 0, texture: context.get_instance("assets/tiles/can_move.png", true) }),
        ...
        make_control_panel() { // Draw the scene's buttons, setup their actions and keyboard shortcuts, and monitor live measurements. 
            this.result_img = this.control_panel.appendChild(Object.assign(document.createElement("img"), { style: "width:200px; height:" + 200 * this.aspect_ratio + "px" }));
        }
                        ...
                        for (let g in this.geese) {
                            ...
                            if (this.geese[g] != this.last_selected_unit && tile_pos.x == this.marker_tile_select.x &&
                                ...
                                this.forecast = new Battle_Forecast(this.shapes.menu_quad, this.shapes.text_menu_line, {
                                    ...
                                    bar_back: this.materials.gray
                                }, graphics_state.camera_transform, position, 18, 23, this.last_selected_unit, this.geese[g], this.turn);
                                break;
                            } else {
                                this.forecast = undefined;
                            }
